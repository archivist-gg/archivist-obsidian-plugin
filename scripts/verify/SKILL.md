...
- **Hidden DESCENDANT of a rendered root.** These really are skipped. In the same pass the ONE rendered panel, `#panel-passive`, returned **568** characters of `innerText` against **12002** of `textContent`, its collapsed rows dropped. That gap is also what proves the reading was taken with layout live rather than flattened.
