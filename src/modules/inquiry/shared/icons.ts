...
/**
 * Safely parses an SVG string and appends the resulting <svg> element as a
 * child of `el`. Used in place of direct HTML assignment so Obsidian's
 * plugin review does not flag unsafe DOM writes.
 */
export function appendSvg(el: HTMLElement, svgString: string): void {
