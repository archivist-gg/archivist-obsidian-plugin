...
/** Random flavor words shown when response completes (e.g., "Crafted in 1:23"). */
...
export interface ThinkingFlavor {
  text: string;
  icon: string;  // Lucide or Tabler icon name
}
...
export const FLAVOR_TEXTS: ThinkingFlavor[] = [
  ...
  // Adventure / Combat / Exploration (10)
